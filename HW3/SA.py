...
def simulated_annealing(func, x0, allowed, t0, t_final, initial_step=10, step_reduction=0.9, temperature_reduction=0.5, num_iterations=10, num_cycles=100, time_constraint=15):
    ...
    while current_temperature > t_final:
        ...
        for _ in range(num_iterations):
            for _ in range(num_cycles):
                for d in range(input_dimension):
                    ...
                    unit_vector = create_unit_vector(input_dimension, d)

                    new_step_point = current_point + random_step_weight * step_vector * unit_vector
        ...
        step_vector = np.array([step_size] * input_dimension, dtype=float)
...
if __name__ == "__main__":
    ...
    print(simulated_annealing(test_func, (25, 25), [[], []], 25000, 0.1))